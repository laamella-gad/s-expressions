...
public class SExpressionsToTreeParser implements SExpressionsStreamingParser.Callback {
    ...
    public void onListBegin() {
        stack.push(new AtomList(null, new ArrayList<>(), comments));
        comments = new ArrayList<>();
    }
    ...
    public void onCloseStream() {
        ...
        document = new Document(document.asList(), comments);
    ...
    public SExpressionsToTreeParser(Callback callback) {
